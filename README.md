...
Simulation is presented in a very intuitive way where you can draw obstacles and place the goal and robot in the screen. In the left side, you can find the tool bar with the next buttons:
...
**Go!**
Once everything is done press Go!
